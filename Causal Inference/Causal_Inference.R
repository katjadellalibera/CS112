...
marginaleffect1<- predict(glm1, newdata = treated1, lty = 3, type = "response") - predict(glm1, newdata = control1, type = "response")
plot(c(1:315), marginaleffect1, type = "l", ylim = c(0,1),xlim = c(0,315))
